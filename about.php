...
<head>
    ...
    <title>About Us - Social Casino</title>
...
<main class="main">
    <div class="container">
            ...
            <section class="page-hero">
                <h2>About sweetswoop</h2>
                <p>Discover how we create fun, social, and safe gaming experiences.</p>
            </section>
            ...
            <section class="about-content">
                <div class="content-wrapper">
                    <div class="text-content">
                        <h3>Our Mission</h3>
                        <p>We bring excitement, connection, and entertainment through free, social casino games.</p>
                        
                        <h3>Why We Stand Out</h3>
                        <p>All games are free, social, and designed to bring players together in a fun, engaging environment.</p>
                        
                        <h3>Our Core Values</h3>
                        <ul class="values-list">
                            <li><strong>Safe Play: No real-money transactions</strong></li>
                            <li><strong>Fun First: Games built for enjoyment</strong></li>
                            <li><strong>Responsible Gaming: Mindful and healthy play</strong></li>
                            <li><strong>Inclusive Community: Welcoming everyone</strong></li>
                        </ul>
                    </div>
            ...
            <section class="stats-section">
                ...
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-label">Entertainment Only</div>
                    </div>
                </div>
            </section>
