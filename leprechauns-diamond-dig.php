...
<!-- Mirrored from sweetswoop.site/game.php?title=Leprechaun%27s+Diamond+Dig by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 17 Nov 2025 12:37:46 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Leprechaun's Diamond Dig - Social Casino</title>
...
<header class="header">
    <div class="container">
        ...
        <nav class="nav">
            <ul>
                <li><a href="index-2.html#how-it-works">How to Play</a></li>
                <li><a href="index-2.html#games">Play Now</a></li>
                <li><a href="index-2.html#leaderboard">Leaderboard</a></li>
                <li>
                ...
                <div class="container">
                    <div class="game-wrapper">
                        <div class="game-iframe-container">
                            <iframe 
                                src="https://released.playngonetwork.com/casino/ContainerLauncher?pid=2&amp;gid=leprechaunsdiamonddig&amp;lang=en_GB&amp;practice=1&amp;channel=desktop&amp;demo=2&amp;refresh=1758626796831" 
                                width="100%" 
                                height="600" 
                                frameborder="0" 
                                allowfullscreen
                                title="Leprechaun&#039;s Diamond Dig Game">
                            </iframe>
                        </div>
                        
                        <div class="game-info">
                            <h3>Leprechaun&#039;s Diamond Dig</h3>
                            <p>Experience the thrill of Leprechaun&#039;s Diamond Dig with our free-to-play version!</p>
                            
                            <div class="game-controls">
                                <button class="play-btn" onclick="location.reload()">Restart Game</button>
                                <button class="cta-btn secondary" onclick="window.location.href='index-2.html'">Back to Games</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="related-games-section">
                <div class="container">
                    ...
                    <div class="games-grid">
                            ...
                            <a href="rise-of-orpheus.php?title=Rise+of+Orpheus" class="play-btn">Play Now</a>
                        </div>
                                            </div>
                </div>
            </section>
